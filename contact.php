...
<html lang="en">
    ...
    <body>
        ...
        <div class="container-fluid contact py-5">
            <div class="container py-5">
                <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 900px;">
                    ...
                    <p class="mb-0">Kami di Dinas Komunikasi dan Informatika Sijunjung berkomitmen untuk memberikan layanan terbaik kepada masyarakat. Dengan tim yang berpengalaman dan profesional, kami siap mendukung kebutuhan komunikasi dan informatika Anda. Jangan ragu untuk menghubungi kami jika Anda memiliki pertanyaan atau memerlukan bantuan. Kami siap membantu Anda.</p>
                </div>
                <div class="row g-5 align-items-center">
                    <div class="col-lg-6 wow fadeInLeft" data-wow-delay="0.1s">
                    <h2 class="display-5 mb-2">Formulir Kontak Kami</h2>
                    <p class="mb-4">Formulir kontak saat ini tidak aktif. Dapatkan formulir kontak yang berfungsi dan aktif dengan Ajax & PHP dalam beberapa menit. Cukup salin dan tempelkan berkas-berkasnya, tambahkan sedikit kode, dan selesai.</p>
                    ...
                    <div class="col-lg-6 wow fadeInRight" data-wow-delay="0.3s">
                        <div class="d-flex align-items-center mb-4">
                            ...
                            <div class="ms-4">
                                <h4>Addresses</h4>
                                <p class="mb-0">Kecamaten Sijunjung, Kabupaten Sijunjung, Sumatera Barat 27562</p>
                            </div>
                        </div>
                        <div class="d-flex align-items-center mb-4">
                        ...
                        <div class="d-flex align-items-center mb-4">
                            ...
                            <div class="ms-4">
                                <h4>Email</h4>
                                <p class="mb-0">kominfo@sijunjung.go,id</p>
                                <p class="mb-0">kominfo@sijunjung.go,id</p>
                            </div>
                        </div>
        ...
        style="height: 500px;" 
        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d10007.77416762824!2d100.93699603483543!3d-0.663090569422416!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e2b2d2b1b4f83e1%3A0x3ecfcf4c7b7e65d0!2sDinas%20Komunikasi%20dan%20Informatika%20Sijunjung!5e0!3m2!1sen!2sid!4v1694259649153!5m2!1sen!2sid" 
        loading="lazy" 
